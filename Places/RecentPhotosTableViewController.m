...
@property (retain, nonatomic) NSDictionary *photoList;
@end

@implementation RecentPhotosTableViewController

@synthesize keyList, photoList;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.photoList = [state dictionaryForKey:@"photoList"];
    self.keyList = [state arrayForKey:@"keyList"];
...
{
    NSString *key = [self.keyList objectAtIndex:indexPath.row];
    return [self.photoList objectForKey:key];
    
    //return [self.photoList objectAtIndex:indexPath.row];
}
